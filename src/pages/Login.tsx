    ...
    <div className="min-h-screen flex">
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Sign in to your account to continue managing your appointments.
            </p>
          </div>
      ...
      >
        <div className="text-primary-foreground text-center p-12 max-w-lg">
          ...
          <h2 className="text-3xl font-bold mb-4">MediBook</h2>
          <p className="text-lg opacity-90">
            Manage your appointments efficiently and provide better care to your patients.
          </p>
        </div>
      </div>
    </div>
